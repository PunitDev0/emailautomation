...
export default function LandingPage() {
  ...
  const FeatureCard = ({ icon: Icon, title, description, delay = 0 }) => {
    ...
    return (
      ...
      >
        <div className="w-lg h-96 p-8 text-center bg-gray-900/80 backdrop-blur-xl border-gray-700 rounded-xl flex flex-col justify-between transition-all duration-300">
          <motion.div
            whileHover={{ rotate: 360, scale: 1.2 }}
            transition={{ duration: 0.6, ease: "easeInOut" }}
            className="w-16 h-16 bg-purple-900/50 backdrop-blur-md rounded-full flex items-center justify-center mx-auto mb-6"
          >
    ...
    <div ref={containerRef} className="min-h-screen bg-black text-white">
      <div className="h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            backgroundImage:
              "linear-gradient(135deg, #1F1F1F 10%, #000000 50%, #1F1F1F 100%)",
            backgroundSize: "200% 200%",
          }}
        />

        {/* Blobs - Dark Jelly Style */}
        <motion.div
          className="absolute w-96 h-96 bg-purple-900/30 rounded-full filter blur-3xl"
        ...
        <motion.div
          className="absolute top-20 right-20 w-96 h-96 bg-blue-900/30 rounded-full filter blur-3xl"
        ...
        <div className="z-50">
          <div className="top-6 left-6 z-50 flex items-center justify-center space-x-2 -translate-y-20">
            ...
            <p className="text-lg md:text-2xl font-bold text-white font-inter">Social Synk</p>
          </div>

          {/* Center Content */}
          <div className="z-10 text-center px-4">
            <h1 className="text-4xl md:text-7xl lg:text-9xl mb-6 text-white font-inter leading-tight">
              Automate your email{" "}
              <span className="italic font-medium">campaigns</span> effortlessly.
            </h1>

            <p className="text-gray-300 mb-8 max-w-xl mx-auto text-base md:text-lg font-inter leading-relaxed">
            ...
            <button className="bg-purple-600 text-white px-8 py-4 rounded-full hover:scale-105 transition transform hover:shadow-lg">
      ...
      >
        <motion.div style={{ y }} className="max-w-4xl mx-auto">
          <h1 className="hero-title text-4xl md:text-6xl lg:text-7xl text-white mb-8 leading-tight">
            Automate your{" "}
            <span className="italic font-medium text-purple-400">email campaigns</span>{" "}
            with ease.
          </h1>

          <p className="hero-subtitle text-base md:text-lg text-gray-300 mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          >
            <Button
              size="lg"
              className="bg-purple-600 hover:bg-purple-700 text-white px-10 py-4 text-lg rounded-full shadow-lg hover:shadow-2xl transition-all duration-300"
            >
      ...
      >
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          ...
          <div className="premium-content space-y-12">
            ...
            {/* Favorite Stats Card */}
            <div className="bg-gray-900/80 backdrop-blur-md rounded-2xl p-6 shadow-lg">
              <h4 className="font-semibold text-white mb-4">Your Key Stats</h4>
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-3 bg-gray-800 rounded-lg shadow-sm">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-medium text-white">Emails Sent</div>
                ...
                <div className="flex items-center justify-between p-3 bg-gray-800 rounded-lg shadow-sm">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-medium text-white">Open Rate</div>
                      <div className="text-sm text-gray-400">42.7%</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="premium-image">
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-gray-900/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl">
                <div className="flex items-center justify-between mb-6">
                  <h4 className="font-semibold text-white">Campaign Overview</h4>
                  <div className="w-6 h-6 bg-purple-500 rounded-full"></div>
                </div>

                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="aspect-square bg-gradient-to-br from-purple-600 to-pink-600 rounded-2xl relative overflow-hidden flex items-center justify-center">
                    <div className="text-white text-sm font-medium">Transactional</div>
                  </div>
                  <div className="aspect-square bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl relative overflow-hidden flex items-center justify-center">
                ...
                <div className="space-y-2">
                  <h4 className="font-semibold text-white">Advanced Reports</h4>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <blockquote className="text-2xl md:text-3xl font-medium text-white leading-relaxed mb-8">
                ...
                <span className="text-purple-400">email campaigns</span> and track results effortlessly!
              </blockquote>

              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-purple-900/50 rounded-full flex items-center justify-center text-purple-400 font-bold">
                  S
                </div>
                <div>
                  <div className="font-medium text-white">Emily Carter</div>
                  <div className="text-sm text-gray-400">Marketing Lead, TechStart</div>
                </div>
              </div>
            </motion.div>
      ...
      {/* Final CTA Section */}
      <section className="mx-auto px-6 py-20 text-center bg-gray-900">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Automate Emails — <span className="text-purple-400">3 Months Free!</span>
          </h2>
      ...
      {/* Footer */}
      <footer className="mx-auto px-6 py-12 border-t border-gray-700 bg-gray-950">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
        ...
        >
          <div className="flex items-center justify-center space-x-2">
            <Image src="/assets/logo.png" width={50} height={50} alt="Logo" />
            <span className="text-xl font-bold text-white">Social Synk</span>
          </div>

          <div className="flex justify-center space-x-8 text-sm text-gray-400">
            <a href="https://www.socialsynk.in/" className="hover:text-white transition-colors">
              SOCIAL SYNK
            </a>
            <a href="https://www.socialsynk.in/about" className="hover:text-white transition-colors">
              ABOUT US
            </a>
            <a href="https://www.socialsynk.in/contact" className="hover:text-white transition-colors">
              CONTACT
            </a>
          </div>
