...
export default function TemplateLibrary({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        className="max-w-7xl h-[90vh] p-0 bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30">
        ...
        <div className="flex-1 flex flex-col p-6 pt-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {featuredTemplates.slice(0, 3).map((template, index) => (
                  <motion.div
                    ...
                    <Card
                      className="group cursor-pointer overflow-hidden bg-white/80 backdrop-blur-sm border-white/40 hover:shadow-2xl transition-all duration-500">
                      ...
                      <CardContent className="p-4">
                        <h4
                          className="font-semibold text-gray-800 group-hover:text-blue-600 transition-colors mb-2">
                          {template.name}
                        </h4>
          ...
          <Tabs
            ...
            <motion.div
              ...
              <TabsList
                className="grid grid-cols-6 lg:grid-cols-12 mb-6 bg-white/70 backdrop-blur-sm">
